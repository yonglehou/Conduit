...
{
    [TestClass]
    public abstract class With_two_nodes_created_by_constructor_with_one_actor_each_and_both_opened : SpecificationContext
    {
    ...
    [TestClass]
    public class When_two_node_are_opened_with_two_nodes_created_by_constructor_with_one_actor_each_and_both_opened
        : With_two_nodes_created_by_constructor_with_one_actor_each_and_both_opened
    {
        ...
        public void Then_one_busopened_event_should_publish()
        {
            ...
            Assert.AreEqual<int>(
                1, Actor2.BusOpenedCount,
                "Expected only 1 BusOpened message for Actor2");
        }
        ...
        public void Then_one_announceserviceidentity_event_should_publish()
        {
            ...
            Assert.AreEqual<int>(
                1, Actor2.AnnounceServiceIdentityCount,
                "Expected only 1 AnnounceServiceIdentityCount message for Actor2");
        }
        ...
        public void Then_conduitnode_name_should_match_name_from_serviceidentity_response()
        {
            ...
            Assert.AreEqual<string>(
                typeof(ConduitNode).Name, Actor2.AnnounceServiceIdentity.Name,
                "ConduitNode Name should match for Actor2");
        }
        ...
        public void Then_conduitnode_typename_should_match_typename_from_serviceidentity_response()
        {
            ...
            Assert.AreEqual<string>(
                typeof(ConduitNode).FullName, Actor2.AnnounceServiceIdentity.Type,
                "Conduit Type should match for Actor2");        
        }
        ...
        public void Then_serviceidentity_response_should_contain_7_capabilities()
        {
            ...
            Assert.AreEqual<int>(
                7, Actor2.AnnounceServiceIdentity.Capabilities.Count(),
                "Expected 7 capabilities for Actor2");        
        }
        ...
        public void Then_serviceidentity_response_should_have_testmessage1_capability()
        {
            ...
            Assert.AreEqual<int>(
                1, Actor2.AnnounceServiceIdentity.Capabilities.Where(x => x == typeof(TestMessage1).FullName).Count(),
                "Expected TestMessage1 capability for Actor2");        
        }
        ...
        public void Then_serviceidentity_response_should_have_testmessage2_capability()
        {
            ...
            Assert.AreEqual<int>(
                1, Actor2.AnnounceServiceIdentity.Capabilities.Where(x => x == typeof(TestMessage2).FullName).Count(),
                "Expected TestMessage2 capability for Actor2");
        }
    }
}
