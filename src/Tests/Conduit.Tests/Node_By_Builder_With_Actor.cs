...
{
    [TestClass]
    public abstract class With_a_node_created_by_builder_with_one_actor : SpecificationContext
    {
    ...
    [TestClass]
    public class When_a_node_is_opened_with_a_node_created_by_builder_with_one_actor
        : With_a_node_created_by_builder_with_one_actor
    {
